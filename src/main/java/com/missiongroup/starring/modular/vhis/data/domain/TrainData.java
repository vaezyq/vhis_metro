...
public class TrainData extends BasicsData implements Serializable {
	...
	private List<CarriageData> carriage_Data_List;
	...
	public List<CarriageData> getCarriage_Data_List() {
		return carriage_Data_List;
	}
	public void setCarriage_Data_List(List<CarriageData> carriage_Data_List) {
		this.carriage_Data_List = carriage_Data_List;
	}

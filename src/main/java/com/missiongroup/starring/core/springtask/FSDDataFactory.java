...
public class FSDDataFactory extends DatatFactory {
    ...
    private static String getSmokeStatus(Long dd_csdFlt_a1, Long dd_csd_a1) {
        String smole = "";
        if (dd_csdFlt_a1 == 0 && dd_csd_a1 == 0) {
            smole = "inactive";
        } else if (dd_csdFlt_a1 == 0 && dd_csd_a1 == 1) {
            smole = "active";
        } else if (dd_csd_a1 == 1) {
            smole = "pre-Alarm";

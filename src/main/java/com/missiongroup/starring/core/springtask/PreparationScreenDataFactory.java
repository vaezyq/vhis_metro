...
public class PreparationScreenDataFactory extends DatatFactory {
    ...
    private static Map<String, Object> createKAuxData() {
        ...
        if (dd_cauxk1Close == 1) {
            aux1Status = "Close";
        } else if (dd_cauxk1CloseFault == 1) {
            aux1Status = "CloseFault";
        } else if (dd_cauxk1OpenFault == 1) {
        ...
        if (dd_cauxk2Close == 1) {
            aux2Status = "Close";
        } else if (dd_cauxk2CloseFault == 1) {
            aux2Status = "CloseFault";
        } else if (dd_cauxk2OpenFault == 1) {
    ...
    private static Map<String, Object> createHVACData() {
        ...
        HVACData.put("A1", dd_cTrainSalTemp_a1 >= 127 ? "??" : dd_cTrainSalTemp_a1);
        HVACData.put("A2", dd_cTrainSalTemp_a2 >= 127 ? "??" : dd_cTrainSalTemp_a2);
        HVACData.put("B1", dd_cTrainSalTemp_b1 >= 127 ? "??" : dd_cTrainSalTemp_b1);
        HVACData.put("B2", dd_cTrainSalTemp_b2 >= 127 ? "??" : dd_cTrainSalTemp_b2);
        HVACData.put("C1", dd_cTrainSalTemp_c1 >= 127 ? "??" : dd_cTrainSalTemp_c1);
        HVACData.put("C2", dd_cTrainSalTemp_c2 >= 127 ? "??" : dd_cTrainSalTemp_c2);
        return HVACData;
    }
}

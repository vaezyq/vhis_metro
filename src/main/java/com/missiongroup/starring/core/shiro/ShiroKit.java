...
public class ShiroKit {
	 ...
	 * 获取当前用户的部门数据范围的集合
	 */
//	public static List<String> getDepartDataScope() {
//		String departId = getUser().getDepartId();
//		List<String> subDepartIds = ConstantFactory.me().getSubDepartId(departId);
//		subDepartIds.add(departId);
//		return subDepartIds;
//	}

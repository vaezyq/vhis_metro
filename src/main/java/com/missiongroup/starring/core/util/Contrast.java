...
import com.missiongroup.starring.common.constant.dictmap.factory.DictFieldWarpperFactory;
...
public class Contrast {
     ...
     * @Date 2017/5/9 19:34
     */
    public static String contrastObj(Class<?> dictClass, String key, Object pojo1, Map<Object, Object> pojo2) throws IllegalAccessException, InstantiationException {
     ...
     * @Date 2017/5/9 19:34
     */
    public static String contrastObjByName(Class<?> dictClass, String key, Object pojo1, Map<Object, Object> pojo2) throws IllegalAccessException, InstantiationException {
        AbstractDictMap dictMap = (AbstractDictMap) dictClass.newInstance();
        String str = parseMutiKey(dictMap, key, pojo2) + separator;
        try {
            Class<?> clazz = pojo1.getClass();
     ...
     */
    public static String parseMutiKey(AbstractDictMap dictMap, String key, Map<Object, Object> requests) {
        StringBuilder sb = new StringBuilder();
        if (key.indexOf(",") != -1) {
            String[] keys = key.split(",");
            for (String item : keys) {
                String fieldWarpperMethodName = dictMap.getFieldWarpperMethodName(item);
                Object value = requests.get(item);
                if (fieldWarpperMethodName != null) {

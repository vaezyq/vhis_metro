...
//	}
     ...
     * 正则判断字符串 是否存在sql注入
     */
    public static boolean isIllegalParam(String o) {
    	String CHECKSQL1 = "^(.+)\\sand\\s(.+)|(.+)\\sor(.+)\\s$";
    	String CHECKSQL2 = "/(\\%27)|(\\’)|(\\-\\-)|(\\%23)|(#)/ix";
    	String CHECKSQL3 = "/((\\%3D)|(=))[^\\n]*((\\%27)|(\\’)|(\\-\\-)|(\\%3B)|(:))/i";
    	String CHECKSQL4 = "/\\w*((\\%27)|(\\’))((\\%6F)|o|(\\%4F))((\\%72)|r|(\\%52))/ix";
    	String CHECKSQL5 = "/((\\%27)|(\\’))union/ix(\\%27)|(\\’)";
    	if(Pattern.matches(CHECKSQL1,o)) {
    		return true;
    	}else if(Pattern.matches(CHECKSQL1, o)) {
    		return true;
    	}else if(Pattern.matches(CHECKSQL2, o)) {
    		return true;
    	}else if(Pattern.matches(CHECKSQL3, o)) {
    		return true;
    	}else if(Pattern.matches(CHECKSQL4, o)) {
    		return true;
    	}else if(Pattern.matches(CHECKSQL5,o)) {
    		return true;
    	}
    	return false;
    }
     ...
     * 非空判断 且字符串SQL注入判断
     */
    public static boolean validateParam(Object o) {

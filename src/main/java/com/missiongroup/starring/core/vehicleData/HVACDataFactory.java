...
public class HVACDataFactory extends DatatFactory {
    ...
    private static String getHvac(Long dd_cClmFaultModHVAC1_, Long dd_cClmStopModHVAC_, Long dd_cClmVentModHVAC_, Long dd_cClmHeatModHVAC_, Long dd_cClmCoolModHVAC_) {
        ...
        if (dd_cClmFaultModHVAC1_ == 0 &&
            ...
            HVAC = "ventilation";
                ...
                dd_cClmStopModHVAC_ == 0 &&
                dd_cClmVentModHVAC_ == 0 && dd_cClmHeatModHVAC_ == 1 && dd_cClmCoolModHVAC_ == 0) {
            HVAC = "heating";
        } else if (dd_cClmFaultModHVAC1_ == 0 &&
                dd_cClmStopModHVAC_ == 0 &&
                dd_cClmVentModHVAC_ == 0 && dd_cClmHeatModHVAC_ == 0 && dd_cClmCoolModHVAC_ == 1) {
            HVAC = "cooling";
        } else if (dd_cClmFaultModHVAC1_ == 0 &&
    ...
    private static Map createCarTargetTemperature() {
        Map<String, Object> data = new HashMap<>();
        Long targetTemp_A1 = getValue("port0x800","_IClmTargetTempManu_A1");
        Long targetTemp_A2 = getValue("port0x800","_IClmTargetTempManu_A2");
        Long targetTemp_B1 = getValue("port0x800","_IClmTargetTempManu_B1");
        Long targetTemp_B2 = getValue("port0x800","_IClmTargetTempManu_B2");
        Long targetTemp_C1 = getValue("port0x800","_IClmTargetTempManu_C1");
        Long targetTemp_C2 = getValue("port0x800","_IClmTargetTempManu_C2");

        data.put("a1", targetTemp_A1);
        data.put("a2", targetTemp_A2);
        data.put("b1", targetTemp_B1);
        data.put("b2", targetTemp_B2);
        data.put("c1", targetTemp_C1);
        data.put("c2", targetTemp_C2);
        return data;
    }

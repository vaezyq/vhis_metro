...
public class MainTrainSynopticDataFactory extends DatatFactory {
    ...
    private static String getCHVSStatus(Long dd_chvsPantoUpFlt_, Long dd_chvsPantoDownFlt_, Long dd_chvsPantoLoweringFlt_, Long dd_chvsPantoRisingFlt_, Long dd_chvsPantoRaisedHV_, Long dd_chvsPantoRaised_, Long dd_chvsPantoLoweredSts_, Long dd_chvsPantoRisingSts_, Long dd_chvsPantoLoweringSts_) {
        String pantograph_ = "";
        if (dd_chvsPantoUpFlt_ == 1) {
            pantograph_ = "Pantograph_in_UP_position_and_faulty";
        } else if (dd_chvsPantoLoweringFlt_ == 1 && dd_chvsPantoUpFlt_ == 0) {
            pantograph_ = "Pantograph_Lowering_faulty";
        } else if (dd_chvsPantoDownFlt_ == 1 && dd_chvsPantoLoweringFlt_ == 0 && dd_chvsPantoUpFlt_ == 0) {
    ...
    private static Map keyData() {
        ...
        if (dd_cKeySw_a1 == 1 && dd_cKeySw_a2 == 1 && dd_cCab1Active == 1) {
            key = "a2";
        } else if (dd_cKeySw_a1 == 1 && dd_cKeySw_a2 == 1 && dd_cCab2Active == 1) {
            key = "a1";
            //((DD_CCab1Active = true AND DD_CCab2Active = true) or (DD_CCab1Active = false AND DD_CCab2Active = false)) AND DD_CKeySw_A1 = true  AND  DD_CKeySw_A2 = true
        } else if (((dd_cCab1Active == 1 && dd_cCab2Active == 1) || (dd_cCab1Active == 0 && dd_cCab2Active == 0)) && dd_cKeySw_a1 == 1 && dd_cKeySw_a2 == 1) {
            key = "a2_a1";
        }
        data.put("key", key);
        return data;
    ...
    /**
     * 21.03.15更新
     * @param dd_cDrsDDClosed
     * @param dd_cDrsDDUnlocked
     * @param dd_cDrsURSOperated
     * @param dd_cDrsURSCOpened
     * @return
     */
    private static String getDetrsinment(Long dd_cDrsDDClosed, Long dd_cDrsDDUnlocked, Long dd_cDrsURSOperated, Long dd_cDrsURSCOpened) {
        ...
        if (dd_cDrsDDClosed == 1 && dd_cDrsDDUnlocked == 1) {
            detrainmentDoor = "open_unlocked_Blinking";
        } else if (dd_cDrsDDClosed == 0) {
    ...
    private static Map getDoorData(Long dd_cDrsFault1_a1, Long dd_cDrsIsol1_a1, Long dd_cDrsCommOk1_a1, Long dd_cDrsObstr1_a1, Long dd_cDrsOpened1_a1, Long dd_cDrsClosedAndLckd1_a1, Long dd_cDrsIsolEle1_a1, Long dd_cDrsEmHand1_a1) {
        Map<String, Object> DEHEIS = new HashMap<>();
    ...
    private static String getDoorStatus(Long dd_cDrsFault1_a1, Long dd_cDrsIsol1_a1, Long dd_cDrsCommOk1_a1, Long dd_cDrsObstr1_a1, Long dd_cDrsOpened1_a1, Long dd_cDrsClosedAndLckd1_a1) {
        String door_1 = "open";
        if (dd_cDrsFault1_a1 == 1 &&  dd_cDrsIsol1_a1 == 0 &&  dd_cDrsCommOk1_a1 == 1) {
            door_1 = "fault";
            return door_1;
        }
        if (dd_cDrsObstr1_a1 == 1 &&  dd_cDrsFault1_a1 == 0 &&  dd_cDrsIsol1_a1 == 0 &&  dd_cDrsCommOk1_a1 == 1) {
            door_1 = "obstruction";
            return door_1;
        }
        if (dd_cDrsOpened1_a1 == 1 && dd_cDrsObstr1_a1 == 0 &&  dd_cDrsFault1_a1 == 0 && dd_cDrsIsol1_a1 == 0 &&
                dd_cDrsCommOk1_a1 == 1 &&  dd_cDrsClosedAndLckd1_a1 == 0) {
            door_1 = "open";
            return door_1;
        }
        if (dd_cDrsOpened1_a1 == 0 && dd_cDrsObstr1_a1 == 0 &&  dd_cDrsFault1_a1 == 0 &&  dd_cDrsIsol1_a1 == 0 &&
                dd_cDrsCommOk1_a1 == 1 &&   dd_cDrsClosedAndLckd1_a1 == 1) {
            door_1 = "closed";
            return door_1;

        }
        if (dd_cDrsIsol1_a1 == 1 && dd_cDrsCommOk1_a1 == 1) {
            door_1 = "Isolated";
            return door_1;

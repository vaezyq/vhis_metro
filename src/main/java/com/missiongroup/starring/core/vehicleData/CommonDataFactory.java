...
public class CommonDataFactory extends DatatFactory {
    ...
    public static Map createData() {
        ...
        Map trainStateData = createTrainStateData();
        data.put("state_Of_Train", trainStateData);
    ...
    private static Map createTrainStateData() {
        Map<String, Object> data = new HashMap<>();
        Long mpu_cunitoper = getValue("port0x100", "MPU_CUnitOper");
        Long mpu_cshutdowninp = getValue("port0x100", "MPU_CShutDownInP");
        String status;
        if (mpu_cunitoper == 1 && mpu_cshutdowninp == 0) {
            status = "RUN";
        } else if (mpu_cunitoper == 0 && mpu_cshutdowninp == 1) {
            status = "DORMANT";
        } else {
            status = "DISCONNECT";
        }
        data.put("TrainState", status);
        return data;
    }
    ...
    private static Map createATPStatusData() {
        ...
        Long dd_catcIsol = getValue("port0x120", "DD_CATCIsol");
        ...
        } else if ((dd_catc1Flt == 1 || dd_catc2Flt == 1) && dd_catcIsol == 0) {
            ATPStatus = "ATP_Fault";
        } else if (dd_catc1OK == 1 && dd_catc2OK == 1 && (dd_catc1Master == 1 || dd_catc2Master == 1)) {
            ATPStatus = "ATP_OK";
        } else {
            ATPStatus = "unknown";
        }
    ...
    private static Map createOtherInformationData() {
        ...
        // TODO: 2021/1/20 处理列车号
        int trainNum = mpu_cTrainNumber.toString().length();
        String linetrain = trainNum <= 1 ? "070" + mpu_cTrainNumber : "07" + mpu_cTrainNumber;
        data.put("mpu_cTrainNumber", linetrain);
        //时间
     ...
     */
    private static Map detrainmentData() {
        Map<String, Object> data = new HashMap<>();
    ...
    private static Map fireData() {
        ...
        Long dd_cFireLVBox_a1 = getValue("port0x121", "DD_CFireLVBox_A1");
        String fire_alam_a1 = "";
        if (dd_csdFlt_a1 + dd_csd_a1 + dd_cFireExt1_a1 + dd_cFireExt2_a1 + dd_cFireExt3_a1 + dd_cFireExt4_a1 +
                dd_cFireFltCVS_a1 + dd_cFireFltBat_a1 + dd_cFireFltLVBox_a1 + dd_cFireBat_a1 + dd_cFireCVS_a1 + dd_cFireLVBox_a1 == 0) {
            fire_alam_a1 = "no_active";
        }else if ((dd_csdFlt_a1 == 1 || dd_cFireFltCVS_a1 == 1 || dd_cFireFltBat_a1 == 1 || (dd_cFireExt1_a1 == 0 &&
                dd_cFireExt2_a1 == 0 && dd_cFireExt3_a1 ==0 && dd_cFireExt4_a1 == 0) || dd_cFireFltLVBox_a1 == 1 ) &&
                (dd_csd_a1 == 0 && dd_cFireCVS_a1 == 0 && dd_cFireBat_a1 == 0 && dd_cFireLVBox_a1 == 0)) {
            ...
            fire_alam_a1 = "yellow";
        }else if (dd_csdFlt_a1 == 1 || dd_csd_a1 == 1 || dd_cFireExt1_a1 == 1 || dd_cFireExt2_a1 == 1 || dd_cFireExt3_a1 == 1 ||
                dd_cFireExt4_a1 == 1 || dd_cFireFltCVS_a1 == 1 || dd_cFireFltBat_a1 == 1 || dd_cFireCVS_a1 == 1 || dd_cFireBat_a1 == 1
                || dd_cFireLVBox_a1 == 1) {
        ...
        Long dd_cFireLVBox_a2 = getValue("port0x121", "DD_CFireLVBox_A2");

        String fire_alam_a2 = "";
        if (dd_csdFlt_a2 + dd_csd_a2 + dd_cFireExt1_a2 + dd_cFireExt2_a2 + dd_cFireExt3_a2 + dd_cFireExt4_a2 +
                dd_cFireFltCVS_a2 + dd_cFireFltBat_a2 + dd_cFireFltLVBox_a2 + dd_cFireBat_a2 + dd_cFireCVS_a2 + dd_cFireLVBox_a2 == 0) {
            fire_alam_a2 = "no_active";
        }else if ((dd_csdFlt_a2 == 1 || dd_cFireFltCVS_a2 == 1 || dd_cFireFltBat_a2 == 1 || ( dd_cFireExt1_a2 == 0 &&
                dd_cFireExt2_a2 == 0 && dd_cFireExt3_a2 == 0 && dd_cFireExt4_a2 == 0) || dd_cFireFltLVBox_a2 == 1) &&
                (dd_csd_a2 == 0 && dd_cFireCVS_a2 == 0 && dd_cFireBat_a2 == 0 && dd_cFireLVBox_a2 == 0)) {
            //At least one smoke detector or
            //fire detector faulty or fire
            //extinguisher active and no smoke
            //detector or fire detector activated
            fire_alam_a2 = "yellow";
        } else if (dd_csdFlt_a2 == 1 || dd_csd_a2 == 1 || dd_cFireExt1_a2 == 1 || dd_cFireExt2_a2 == 1 || dd_cFireExt3_a2 == 1 ||
                dd_cFireExt4_a2 == 1 || dd_cFireFltCVS_a2 == 1 || dd_cFireFltBat_a2 == 1 || dd_cFireCVS_a2 == 1 || dd_cFireBat_a2 == 1
                || dd_cFireLVBox_a2 == 1) {
            //At least one smoke/fire detector is activated
            fire_alam_a2 = "red";
        }
        ...
        String fire_alam_b1 = "";
        if (dd_csdFlt_b1 + dd_csd_b1 + dd_cFireExt1_b1 + dd_cFireFltTraction_b1 + dd_cFireFltLVBox_b1 + dd_cFireFltHVBox_b1 + dd_cFireInPCE_b1 +
                dd_cFireExt2_b1 + dd_cFireExt3_b1 + dd_cFireExt4_b1 + dd_cFireLVBox_b1 + dd_cFireHVBox_b1 == 0) {
            fire_alam_b1 = "no_active";
        }else if ((dd_csdFlt_b1 == 1 || dd_cFireFltTraction_b1 == 1 || (dd_cFireExt1_b1 == 0 && dd_cFireExt2_b1 == 0 && dd_cFireExt3_b1 == 0  &&
                dd_cFireExt4_b1 == 0) || dd_cFireFltLVBox_b1 == 1 || dd_cFireFltHVBox_b1 == 1) &&
                (dd_csd_b1 == 0 && dd_cFireInPCE_b1 == 0 && dd_cFireLVBox_b1 == 0 && dd_cFireHVBox_b1 == 0)) {
            //At least one smoke detector or
            //fire detector faulty or fire
            //extinguisher active and no smoke
            //detector or fire detector activated
            fire_alam_b1 = "yellow";
        }  else if (dd_csdFlt_b1 == 1 || dd_csd_b1 == 1 || dd_cFireExt1_b1 == 1 || dd_cFireFltTraction_b1 == 1 || dd_cFireFltLVBox_b1 == 1 ||
                dd_cFireFltHVBox_b1 == 1 || dd_cFireInPCE_b1 == 1 || dd_cFireExt2_b1 == 1 || dd_cFireExt3_b1 == 1 || dd_cFireExt4_b1 == 1 ||
                dd_cFireLVBox_b1 == 1 || dd_cFireHVBox_b1 == 1) {
            //At least one smoke/fire detector is activated
            fire_alam_b1 = "red";
        }
        ...
        String fire_alam_b2 = "";
        if (dd_csdFlt_b2 + dd_csd_b2 + dd_cFireExt1_b2 + dd_cFireExt2_b2 + dd_cFireExt3_b2 + dd_cFireExt4_b2 + dd_cFireFltTraction_b2 +
                dd_cFireFltLVBox_b2 + dd_cFireFltHVBox_b2 + dd_cFireInPCE_b2 + dd_cFireLVBox_b2 + dd_cFireHVBox_b2 == 0) {
            fire_alam_b2 = "no_active";
        }else if ((dd_csdFlt_b2 == 1 || dd_cFireFltTraction_b2 == 1 || (dd_cFireExt1_b2 == 0 && dd_cFireExt2_b2 == 0 && dd_cFireExt3_b2 == 0 &&
                dd_cFireExt4_b2 == 0) || dd_cFireFltLVBox_b2 == 1 || dd_cFireFltHVBox_b2 == 1) &&
                (dd_csd_b2 == 0 && dd_cFireInPCE_b2 == 0 && dd_cFireLVBox_b2 == 0 && dd_cFireHVBox_b2 == 0)) {
            //At least one smoke detector or
            //fire detector faulty or fire
            //extinguisher active and no smoke
            //detector or fire detector activated
            fire_alam_b2 = "yellow";
        }else if (dd_csdFlt_b2 == 1 || dd_csd_b2 == 1 || dd_cFireExt1_b2 == 1 || dd_cFireFltTraction_b2 == 1 || dd_cFireFltLVBox_b2 == 1 ||
                dd_cFireFltHVBox_b2 == 1 || dd_cFireInPCE_b2 == 1 || dd_cFireExt2_b2 == 1 || dd_cFireExt3_b2 == 1 || dd_cFireExt4_b2 == 1 ||
                dd_cFireLVBox_b2 == 1 || dd_cFireHVBox_b2 == 1) {
            //At least one smoke/fire detector is activated
            fire_alam_b2 = "red";
        }
        ...
        //Long dd_cFireExt4_c1 = getValue("port0x123", "DD_CFireExt4_C1");
        ...
        Long dd_cFireLVBox_C1 = getValue("port0x121", "DD_CFireLVBox_C1");

        String fire_alam_c1 = "";
        if (dd_csdFlt_c1 + dd_csd_c1 + dd_cFireExt1_c1 + dd_cFireExt2_c1 + dd_cFireExt3_c1 + dd_cFireFltCVS_c1 +
                dd_cFireFltTraction_c1 + dd_cFireFltLVBox_c1 + dd_cFireInPCE_c1 + dd_cFireCVS_c1 + dd_cFireLVBox_C1 == 0) {
            fire_alam_c1 = "no_active";
        } else if ((dd_csdFlt_c1 == 1 || (dd_cFireExt1_c1 == 0 && dd_cFireExt2_c1 == 0 && dd_cFireExt3_c1 == 0) ||
                dd_cFireFltCVS_c1 == 1 || dd_cFireFltTraction_c1 == 1 || dd_cFireFltLVBox_c1 == 1) &&
                (dd_csd_c1 == 0 && dd_cFireInPCE_c1 == 0 && dd_cFireCVS_c1 == 0 && dd_cFireLVBox_C1 == 0)) {
            //At least one smoke detector or
            //fire detector faulty or fire
            //extinguisher active and no smoke
            //detector or fire detector activated
            fire_alam_c1 = "yellow";
        }else if (dd_csdFlt_c1 == 1 || dd_csd_c1 == 1 || dd_cFireExt1_c1 == 1 || dd_cFireExt2_c1 == 1 || dd_cFireExt3_c1 == 1 ||
                dd_cFireFltCVS_c1 == 1 || dd_cFireFltTraction_c1 == 1 || dd_cFireFltLVBox_c1 == 1 || dd_cFireInPCE_c1 == 1 ||
                dd_cFireCVS_c1 == 1 || dd_cFireLVBox_C1 == 1) {
            //At least one smoke/fire detector is activated
            fire_alam_c1 = "red";
        }
        ...
        Long dd_cFireLVBox_C2 = getValue("port0x121", "DD_CFireLVBox_C2");

        String fire_alam_c2 = "";
        if (dd_csdFlt_c2 + dd_csd_c2 + dd_cFireExt1_c2 + dd_cFireFltCVS_c2 + dd_cFireFltBat_c2 + dd_cFireFltTraction_c2 + dd_cFireLVBox_C2 +
                dd_cFireFltLVBox_c2 + dd_cFireBat_c2 + dd_cFireInPCE_c2 + dd_cFireCVS_c2 + dd_cFireExt2_c2 + dd_cFireExt3_c2 + dd_cFireExt4_c2 == 0) {
            fire_alam_c2 = "no_active";
        } else if ((dd_csdFlt_c2 == 1 || (dd_cFireExt1_c2 == 0 && dd_cFireExt2_c2 == 0 && dd_cFireExt3_c2 == 0 && dd_cFireExt4_c2 == 0) ||
                dd_cFireFltCVS_c2 == 1 || dd_cFireFltBat_c2 == 1 || dd_cFireFltTraction_c2 == 1 || dd_cFireFltLVBox_c2 == 1 || dd_cFireBat_c2 == 1) &&
                (dd_csd_c2 == 0 && dd_cFireInPCE_c2 == 0 && dd_cFireCVS_c2 == 0 && dd_cFireLVBox_C2 == 0)) {
            //At least one smoke detector or
            //fire detector faulty or fire
            //extinguisher active and no smoke
            //detector or fire detector activated
            fire_alam_c2 = "yellow";
        } else if (dd_csdFlt_c2 == 1 || dd_csd_c2 == 1 || dd_cFireExt1_c2 == 1 || dd_cFireFltCVS_c2 == 1 || dd_cFireFltBat_c2 == 1 ||
                dd_cFireFltTraction_c2 == 1 || dd_cFireLVBox_C2 == 1 || dd_cFireFltLVBox_c2 == 1 || dd_cFireBat_c2 == 1 || dd_cFireInPCE_c2 == 1
                || dd_cFireCVS_c2 == 1 || dd_cFireExt2_c2 == 1 || dd_cFireExt3_c2 == 1 || dd_cFireExt4_c2 == 1) {
            //At least one smoke/fire detector is activated
            fire_alam_c2 = "red";
        }

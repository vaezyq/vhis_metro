...
public class OperationDataFactory extends DatatFactory {
    ...
    private static Map createBrakeStatus() {
        Map<String, Object> data = new HashMap<>();
        String dd_cFricBrkPresBog1_a1 = String.format("%.1f", getValue("port0x134", "DD_CFricBrkPresBog1_A1") * 0.1);
        String dd_cFricBrkPresBog2_a1 = String.format("%.1f", getValue("port0x134", "DD_CFricBrkPresBog2_A1") * 0.1);
        String dd_cFricBrkPresBog1_a2 = String.format("%.1f", getValue("port0x134", "DD_CFricBrkPresBog1_A2") * 0.1);
        String dd_cFricBrkPresBog2_a2 = String.format("%.1f", getValue("port0x134", "DD_CFricBrkPresBog2_A2") * 0.1);
        String dd_cFricBrkPresBog1_b1 = String.format("%.1f", getValue("port0x134", "DD_CFricBrkPresBog1_B1") * 0.1);
        String dd_cFricBrkPresBog2_b1 = String.format("%.1f", getValue("port0x134", "DD_CFricBrkPresBog2_B1") * 0.1);
        String dd_cFricBrkPresBog1_b2 = String.format("%.1f", getValue("port0x134", "DD_CFricBrkPresBog1_B2") * 0.1);
        String dd_cFricBrkPresBog2_b2 = String.format("%.1f", getValue("port0x134", "DD_CFricBrkPresBog2_B2") * 0.1);
        String dd_cFricBrkPresBog1_c1 = String.format("%.1f", getValue("port0x134", "DD_CFricBrkPresBog1_C1") * 0.1);
        String dd_cFricBrkPresBog2_c1 = String.format("%.1f", getValue("port0x134", "DD_CFricBrkPresBog2_C1") * 0.1);
        String dd_cFricBrkPresBog1_c2 = String.format("%.1f", getValue("port0x134", "DD_CFricBrkPresBog1_C2") * 0.1);
        String dd_cFricBrkPresBog2_c2 = String.format("%.1f", getValue("port0x134", "DD_CFricBrkPresBog2_C1") * 0.1);
